...
from cskd.models.helpers import build_model_with_cfg
from cskd.models.layers import ClassifierHead, AvgPool2dSame, ConvBnAct, SEModule, DropPath
from cskd.models.registry import register_model
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = ConvBnAct(
            bottleneck_chs, bottleneck_chs, kernel_size=3, stride=stride, dilation=dilation, groups=groups, **cargs
        )
        if se_ratio:
...
class RegNet(nn.Module):
    ...
    def _get_stage_params(self, cfg, default_stride=2, output_stride=32, drop_path_rate=0.0):
        ...
        stage_params = [
            ...
            for params in zip(
                stage_widths, stage_strides, stage_dilations, stage_depths, stage_bottle_ratios, stage_groups, stage_dpr
            )
        ]
        return stage_params
    ...
    def forward(self, x):
        ...
        # torch.Size([2, 224, 56, 56])
        # torch.Size([2, 448, 28, 28])
        # torch.Size([2, 1232, 14, 14])
