...
for img in os.listdir("/Users/touchnow/Downloads/102flowers/jpg"):
    ######## flower data ########
    flower_dir.append(os.path.join("/Users/touchnow/Downloads/102flowers/jpg", img))
