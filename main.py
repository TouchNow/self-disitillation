...
def train(
    ...
    for step, (inputs, target) in enumerate(loader):
        ...
        loss_scaler(
            ...
            parameters=distiller.parameters(),
...
def main():
    ...
    optimizer = create_optimizer(cfg, distiller)
    ...
    for epoch in range(start_epoch, cfg.epochs):
        ...
        if local_rank == 0:
            ...
            if save_best:
                if save_checkpoint(cfg.log_dir, "best", checkpoint) and save_checkpoint(
                    cfg.log_dir, "best_student", checkpoint_student
                ):
